...
class SimulationSpecifications(Collection):
    ...
    def __init__(self, com):
        ...
        self.simulation_specifications = com

    def item(self, i_index: 'cat_variant') -> SimulationObject:
        return SimulationObject(self.simulation_specifications.Item(i_index))

    def __getitem__(self, n: int) -> SimulationObject:
        if (n + 1) > self.count():
            raise StopIteration

        return SimulationObject(self.simulation_specifications.item(n + 1))
