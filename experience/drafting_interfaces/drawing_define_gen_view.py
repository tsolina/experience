...
class DrawingDefineGenView(AnyObject):
    ...
    def define_front_view(self, i_xpos: float, i_ypos: float, i_list_of_prd_inst: 'cat_variant', i_plane: 'cat_variant', i_view_style: str, 
    ...
    def define_isometric_view(self, i_xpos: float, i_ypos: float, i_list_of_prd_inst: 'cat_variant', i_plane: 'cat_variant', i_view_style: str,
                              i_compute_update: bool, i_view_prop: 'DrawingGenViewProperties') -> 'DrawingView':
        from experience.drafting_interfaces import DrawingView
    ...
    def define_polygonal_detail_view(self, i_xpos: float, i_ypos: float, i_profile: 'cat_variant', i_parent_view: 'DrawingView', i_view_style: str,
                                     i_compute_update: bool, i_view_prop: 'DrawingGenViewProperties') -> 'DrawingView':
        from experience.drafting_interfaces import DrawingView
    ...
    def define_projection_view(self, i_xpos: float, i_ypos: float, i_parent_view: 'DrawingView', i_type: int, i_view_style: str,
                                     i_compute_update: bool, i_view_prop: 'DrawingGenViewProperties') -> 'DrawingView':
        from experience.drafting_interfaces import DrawingView
        return DrawingView(self.drawing_define_gen_view.DefineProjectionView(i_xpos, i_ypos, i_parent_view._com, i_type, i_view_style, i_compute_update, i_view_prop))
    
    def define_section_view(self, i_xpos: float, i_ypos: float, i_profile: 'cat_variant', i_section_type: str, i_profile_type: str, i_side_to_draw: int, 
    ...
    def define_standalone_section(self, i_xpos: float, i_ypos: float, i_list_of_prd_ints: 'cat_variant', profil: 'cat_variant', type_of_section: str,
                                  type_of_profile: str, i_plane: 'cat_variant', i_side: int,
                                  i_view_style: str, i_compute_update: bool, i_view_prop: 'DrawingGenViewProperties') -> 'DrawingView':
        from experience.drafting_interfaces import DrawingView
    ...
    def define_unfolded_view(self, i_xpos: float, i_ypos: float, i_list_of_prd_ints: 'cat_variant', i_plane: 'cat_variant',
                                  i_view_style: str, i_compute_update: bool, i_view_prop: 'DrawingGenViewProperties') -> 'DrawingView':
        from experience.drafting_interfaces import DrawingView
